...
exports.transform = function (model) {
    var groupNames = {
        "constructor": { items: [], key: "constructorsInSubtitle" },
        "field": { items: [], key: "fieldsInSubtitle" },
        "property": { items: [], key: "propertiesInSubtitle" },
        "method": { items: [], key: "methodsInSubtitle" },
        "event": { items: [], key: "eventsInSubtitle" },
        "operator": { items: [], key: "operatorsInSubtitle" },
    };
