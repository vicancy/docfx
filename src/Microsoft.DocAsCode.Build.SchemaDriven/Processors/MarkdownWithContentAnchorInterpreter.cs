...
namespace Microsoft.DocAsCode.Build.SchemaDriven.Processors
{
    public class MarkdownWithContentAnchorInterpreter : IInterpreter
    {
        ...
        public object Interpret(BaseSchema schema, object value, IProcessContext context, string path)
        {
            ...
            if ((schema == null ||schema.Reference == ReferenceType.None) && val.Trim() == AnchorContentStatus.AnchorContentName)
            {
                var status = context.Properties.AnchorContentStatus as AnchorContentStatus;
                status.ContainsAnchor = true;
